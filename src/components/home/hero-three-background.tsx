      ...
      const [
        ...
        const animate = () => {
          ...
          if (!reduceMotion) {
            ...
            // Start 45% rotated from previous initial pose.
            const targetYaw = (-0.30 + fullTurn * 0.45) + scrollProgress * fullTurn + pointer.x * 0.24
            ...
            petsRoot.rotation.y = -0.18 + Math.PI * 0.9
