      ...
      const [
        ...
        const animate = () => {
          ...
          if (!reduceMotion) {
            ...
            // Start 25% rotated from previous initial pose.
            const targetYaw = (-0.30 + fullTurn * 0.25) + scrollProgress * fullTurn + pointer.x * 0.24
            ...
            petsRoot.rotation.y = -0.18 + Math.PI * 0.5
